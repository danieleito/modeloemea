...
public class ManifestacaoRepeticao implements Serializable {
    ...
    public ManifestacaoRepeticao(int id, String criterio, String limiteSuperior, String capa3) {
        this.id = id;
    ...
    public ManifestacaoRepeticao(String criterio, String limiteSuperior, String capa3) {
        this.criterio = criterio;
        this.limiteSuperior = limiteSuperior;
        this.capa3 = capa3;
    }
