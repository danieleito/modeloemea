...
public class ManifestacaoUrgencia implements Serializable {
    ...
    public ManifestacaoUrgencia(int id, String descricao, String criterio, String capa4) {
        this.id = id;
    ...
    public ManifestacaoUrgencia(String descricao, String criterio, String capa4) {
        this.descricao = descricao;
        this.criterio = criterio;
        this.capa4 = capa4;
    }
