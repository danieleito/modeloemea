...
insert into ARQUIVO_ANEXO_INSPECAO (ID_INSPECAO, DS_ARQUIVO, DS_TIPO_ARQUIVO, NR_NUMERO, DS_DESCRICAO, DS_REGISTRO, DT_DATA_ANEXACAO, ID_IMAGEM) values (1, '01.jpg', 'Foto', '10', 'foto10', 'MAN', '31/10/2012', 32);
insert into ARQUIVO_ANEXO_INSPECAO (ID_INSPECAO, DS_ARQUIVO, DS_TIPO_ARQUIVO, NR_NUMERO, DS_DESCRICAO, DS_REGISTRO, DT_DATA_ANEXACAO, ID_IMAGEM) values (1, '01.jpg', 'Foto', '11', 'foto11', 'MAN', '31/10/2012', 33);
insert into ARQUIVO_ANEXO_INSPECAO (ID_INSPECAO, DS_ARQUIVO, DS_TIPO_ARQUIVO, NR_NUMERO, DS_DESCRICAO, DS_REGISTRO, DT_DATA_ANEXACAO, ID_IMAGEM) values (1, '01.jpg', 'Foto', '12', 'foto12', 'MAN', '31/10/2012', 34);
insert into ARQUIVO_ANEXO_INSPECAO (ID_INSPECAO, DS_ARQUIVO, DS_TIPO_ARQUIVO, NR_NUMERO, DS_DESCRICAO, DS_REGISTRO, DT_DATA_ANEXACAO, ID_IMAGEM) values (1, '01.jpg', 'Foto', '13', 'foto13', 'MAN', '31/10/2012', 35);
...
insert into DADOS_MANIFESTACAO (DS_TAMANHO, DS_NUMERO, ID_MANIFESTACOES_EXTENSAO, ID_MANIFESTACOES_URGENCIA, ID_ARQUIVO_ANEXO_INSPECAO) values ('tam 1', 'NUM', 1, 1, 1);
insert into DADOS_MANIFESTACAO (DS_TAMANHO, ID_MANIFESTACOES_EXTENSAO, ID_MANIFESTACOES_URGENCIA, ID_ARQUIVO_ANEXO_INSPECAO, DS_VALOR_DANO) values ('tam 2', 2, 2, 2, '0.2');
insert into DADOS_MANIFESTACAO (DS_TAMANHO, ID_MANIFESTACOES_EXTENSAO, ID_MANIFESTACOES_URGENCIA, ID_ARQUIVO_ANEXO_INSPECAO) values ('tam 3', 3, 3, 3);
insert into DADOS_MANIFESTACAO (DS_TAMANHO, ID_MANIFESTACOES_EXTENSAO, ID_MANIFESTACOES_URGENCIA, ID_ARQUIVO_ANEXO_INSPECAO, DS_VALOR_DANO) values ('tam 4', 4, 4, 4, '0.4');
