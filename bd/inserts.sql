...
insert into INSPECAO_ROTINEIRA (ID_INSPECAO, ID_IDENTIFICACAO_OBRA_SGO, ID_CONDICOES_SGO, ID_DANOS_ELEMENTOS_SGO, ID_INSUFICIENCIAS_ESTRUTURAIS_ELEMENTOS_SGO, ID_LAUDO_ESPECIALIZADO_SGO, ID_MONITORAMENTO_SGO, DS_RELATORIO) values (1, 1, 1, 1, 1, 1, 1, 'relatórios1');
insert into INSPECAO_ROTINEIRA (ID_INSPECAO, ID_IDENTIFICACAO_OBRA_SGO, ID_CONDICOES_SGO, ID_DANOS_ELEMENTOS_SGO, ID_INSUFICIENCIAS_ESTRUTURAIS_ELEMENTOS_SGO, ID_LAUDO_ESPECIALIZADO_SGO, ID_MONITORAMENTO_SGO, DS_RELATORIO) values (2, 1, 1, 1, 1, 1, 1, 'relatórios2');
insert into INSPECAO_ROTINEIRA (ID_INSPECAO, ID_IDENTIFICACAO_OBRA_SGO, ID_CONDICOES_SGO, ID_DANOS_ELEMENTOS_SGO, ID_INSUFICIENCIAS_ESTRUTURAIS_ELEMENTOS_SGO, ID_LAUDO_ESPECIALIZADO_SGO, ID_MONITORAMENTO_SGO, DS_RELATORIO) values (3, 1, 1, 1, 1, 1, 1, 'relatórios3');
