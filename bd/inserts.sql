...
insert into DADOS_MANIFESTACAO (DS_FOTO, DS_TAMANHO, DS_NUMERO, ID_MANIFESTACOES_EXTENSAO, ID_MANIFESTACOES_URGENCIA, ID_ARQUIVO_ANEXO_MANIFESTACAO) values ('foto 1', 'tam 1', 'NUM', 1, 1, 1);
insert into DADOS_MANIFESTACAO (DS_FOTO, DS_TAMANHO, ID_MANIFESTACOES_EXTENSAO, ID_MANIFESTACOES_URGENCIA, ID_ARQUIVO_ANEXO_MANIFESTACAO, DS_VALOR_DANO) values ('foto 2', 'tam 2', 2, 2, 2, '0.2');
insert into DADOS_MANIFESTACAO (DS_FOTO, DS_TAMANHO, ID_MANIFESTACOES_EXTENSAO, ID_MANIFESTACOES_URGENCIA, ID_ARQUIVO_ANEXO_MANIFESTACAO) values ('foto 3', 'tam 3', 3, 3, 3);
insert into DADOS_MANIFESTACAO (DS_FOTO, DS_TAMANHO, ID_MANIFESTACOES_EXTENSAO, ID_MANIFESTACOES_URGENCIA, ID_ARQUIVO_ANEXO_MANIFESTACAO, DS_VALOR_DANO) values ('foto 4', 'tam 4', 4, 4, 4, '0.4');
insert into DADOS_MANIFESTACAO (DS_FOTO, DS_TAMANHO, ID_MANIFESTACOES_EXTENSAO, ID_MANIFESTACOES_URGENCIA, DS_VALOR_DANO) values ('foto 5', 'tam 5', 5, 2, '0.5');
insert into DADOS_MANIFESTACAO (DS_FOTO, DS_TAMANHO, ID_MANIFESTACOES_EXTENSAO, ID_MANIFESTACOES_URGENCIA, DS_VALOR_DANO) values ('foto 6', 'tam 6', 1, 1, '0.6');
insert into DADOS_MANIFESTACAO (DS_FOTO, DS_TAMANHO, ID_MANIFESTACOES_EXTENSAO, ID_MANIFESTACOES_URGENCIA, DS_VALOR_DANO) values ('foto 7', 'tam 7', 3, 1, '0.7');
insert into DADOS_MANIFESTACAO (DS_FOTO, DS_TAMANHO, ID_MANIFESTACOES_EXTENSAO, ID_MANIFESTACOES_URGENCIA, DS_VALOR_DANO) values ('foto 8', 'tam 8', 2, 2, '0.8');
insert into DADOS_MANIFESTACAO (DS_FOTO, DS_TAMANHO, ID_MANIFESTACOES_EXTENSAO, ID_MANIFESTACOES_URGENCIA, DS_VALOR_DANO) values ('foto 9', 'tam 9', 5, 3, '0.9');
insert into DADOS_MANIFESTACAO (DS_FOTO, DS_TAMANHO, ID_MANIFESTACOES_EXTENSAO, ID_MANIFESTACOES_URGENCIA, DS_VALOR_DANO) values ('foto 10', 'tam 10', 4, 4, '1.0');
